        ...
        if (!rstn) begin
            ...
            if (bit_count == 4'd10) begin
                if (cur_byte == 8'hE0 || cur_byte == 8'hF0) begin
                    ...
                    // fire on a new key even while another is still held (rollover);
                    // is_valid only suppresses typematic repeats of the same key
                    if (is_valid || cur_byte != scancode) begin
