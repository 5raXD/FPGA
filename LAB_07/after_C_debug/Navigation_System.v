...
// Module:    Navigation_System   (after_C_debug version)
// Notes:     'dir' is now actually updated (the old code only wrote dir_next and
//            never copied it to dir, so the snake never turned). See changes.html.
//////////////////////////////////////////////////////////////////////////////////
