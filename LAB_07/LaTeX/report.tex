...
Basys3 pins (constraints in \texttt{task3.xdc}). It does not contain any game
logic of its own, only instantiations and connect modules together.
...
some of the instantiated modules are for IO purposes and the reset are handle internal logic of the game 

subsubsection{IO modules}
