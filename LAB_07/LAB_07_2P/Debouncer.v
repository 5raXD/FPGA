...
module Debouncer(clk, input_unstable, output_stable);
   ...
   reg prev_msb = 0;                   // power-up values: honored by Vivado,

   reg [COUNTER_BITS-1:0] counter = 0; // and keep the sim free of X

   initial output_stable = 0;          // same for the output pulse reg
